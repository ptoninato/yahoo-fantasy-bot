...
object Arbiter {
    ...
    private fun setupJobs() {
        ...
        JobRunner.createJob(MatchUpJob::class.java, "0 30 3 ? 8-1 FRI *")
        JobRunner.createJob(StandingsJob::class.java, "0 30 3 ? 8-1 FRI *")

        JobRunner.createJob(ScoreUpdateJob::class.java, "0 55 3 ? 8-1 FRI *")
